                ...
                movies.map(movie => ( 
                    <div className="item-carousel max-w-[1280px] mx-auto w-[100vw] h-[100vh] relative">
                        ...
                        <div className="konten absolute text-white max-[375px]:bottom-27 bottom-22 min-[390px]:bottom-35 min-[412px]:bottom-50 min-[540px]:bottom-20 sm:bottom-55 lg:bottom-16 left-9 sm:left-14 lg:left-18 xl:left-28">
                            ...
                            <button className="mt-4 sm:mt-6 px-6 py-2 rounded-3xl bg-white text-black flex justify-center gap-2 items-center cursor-pointer hover:text-white hover:border-[0.7px] hover:bg-black hover:border-white active:text-white active:border-[0.7px] active:bg-black active:border-white transition">
